                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal"
                                data-bs-target="#product" data-bs-whatever="@fat">
                                Create New
                            </button>
                        </div>
                                        ...
                                        <div class="modal-body">
                                            <form id="productForm">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <span id="priceError" class="text-danger errorMessage"></span>
                                                </div>
            ...
            $(document).on('click', '#delete', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: "{{ route('product.delete', ['product' => '__productId']) }}".replace('__productId', productId),
                            method: 'DELETE',
                            success: function(response) {
